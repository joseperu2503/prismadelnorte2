...
@section('content')
                    ...
                    <div id="cursos" class="mt-3">
                        @if (isset($alumnos_checked))
                            <select id="id_curso" name="id_curso" class="form-select mb-3 " style="width:250px" form="form">
                                <option @if($post->id_curso==null) selected @endif disabled value="">Curso</option>
    ...
    {{date("d/m/Y",strtotime($post->fecha_hora))}}
        ...
        <div class="modal-dialog modal-dialog-centered">
          <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <input class="form-control mb-3" type="date" name="fecha" id="fecha-programada" form="form" value="{{date("Y-m-d",strtotime($post->fecha_hora))}}">
                <input class="form-control" type="time" name="hora" id="hora-programada" form="form" value="{{date("H:i",strtotime($post->fecha_hora))}}">
...
@section('js')
    ...
    <script >
        ...
        botonPublicar1.addEventListener('click',function(){
            ...
            postForm.action = "{{route('publicaciones.update',$post->id)}}"
        })
